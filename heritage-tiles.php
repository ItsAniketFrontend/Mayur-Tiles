...
<body>
    ...
    <main>
        ...
        <section class="stone-finish-intro">
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        <h1>Heritage Cement Tile</h1>
                    </div>
                    <div class="col-6 d-flex justify-content-center flex-column">
                        <h3>Features:</h3>
                        <p>&rarr; Highly versatile in fitting </p>
                        <p>&rarr; Color combination can be customised</p>
                    ...
                    <div class="col-6 d-flex align-items-center justify-content-center flex-column">
                        <img src="Images/Wetcast-Pavers/stone-finish-product.png" alt="">
                        <h6>Thickness - 60MM</h6>
                        <h6>Strength - M40</h6>
                    </div>
                </div>
            </div>
        ...
        <section class="stone-finish-gallery">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-12 m-0 p-1">
                        <img src="Images/Stone-Finish/2.JPG" alt="">
                    </div>
                    <div class="col-lg-4 col-6 m-0 p-1">
                        <img src="Images/Stone-Finish/3.JPG" alt="">
                    </div>
                    <div class="col-lg-4 col-6 m-0 p-1">
                        <img src="Images/Stone-Finish/one.JPG" alt="">
                    </div>
                    <div class="col-lg-3 col-12 m-0 p-1">
                        <img src="Images/Stone-Finish/5.JPG" alt="">
                    </div>
                    <div class="col-lg-3 col-6 m-0 p-1">
                        <img src="Images/Stone-Finish/6.JPG" alt="">
                    </div>
                    <div class="col-lg-3 col-6 m-0 p-1">
                        <img src="Images/Stone-Finish/7.JPG" alt="">
                    </div>
                    <div class="col-lg-3 col-12 m-0 p-1">
                        <img src="Images/Stone-Finish/8.JPG" alt="">
                    </div>
                </div>
            </div>
        </section>
