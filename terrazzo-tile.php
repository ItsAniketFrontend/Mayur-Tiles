...
<body>
    ...
    <main>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        <h2>Grey Cement Terrazzo Tile</h2>
                        <p>Outdoor Range</p>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-2 col-6 col-box  my-3" data-aos="fade-right" data-aos-delay="200"
                            ...
                            <div class="product-box">
                                <img src="Images/terrazzo/c-nav.png" alt="">
                                <div class="row stone">
                                    <div class="col-12 text-center">
                        ...
                        <div class="col-lg-2 col-6 col-box  my-3" data-aos="fade-right" data-aos-delay="200"
                            data-aos-duration="800">
                            <div class="product-box">
                                <img src="Images/terrazzo/jiri-grey.png" alt="">
                                <div class="row stone">
                                    <div class="col-12 text-center">
                                        <h3>Jiri Grey</h3>
                                        <button><a href="">Know More</a></button>
                        ...
                        <div class="col-lg-2 col-6 col-box  my-3" data-aos="fade-right" data-aos-delay="200"
                            data-aos-duration="800">
                            <div class="product-box">
                                <img src="Images/terrazzo/jiri-red.png" alt="">
                                <div class="row stone">
                                    <div class="col-12 text-center">
                                        <h3>Jiri Red</h3>
                                        <button><a href="">Know More</a></button>
                        ...
                        <div class="col-lg-2 col-6 col-box  my-3" data-aos="fade-right" data-aos-delay="200"
                            data-aos-duration="800">
                            <div class="product-box">
                                <img src="Images/terrazzo/navrang.png" alt="">
                                <div class="row stone">
                                    <div class="col-12 text-center">
                                        <h3>Navrang</h3>
                                        <button><a href="">Know More</a></button>
        ...
        <section class="terrazzo-second">
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        <h2>White Cement Terrazzo Tiles</h2>
                        <p>Outdoor Range</p>
                        <p>Size:250MM X 250MM</p>
                    </div>
                </div>
        ...
        <section class="venetian-terrazzo">
            <div class="container">
                <div class="row">
                    <div class="col-12">
